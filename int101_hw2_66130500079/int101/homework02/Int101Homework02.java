...
public class Int101Homework02 {
    ...
    static void work01Utilitor() {
        /*
         * 1.1 Create a public utility class named "Utilitor" in package named
         * "work01Utilitor".
        ...
        System.out.println("Check 562314789 : " + Utilitor.computeIsbn10(562_314_789) + '\n');
    ...
    static void work02Person() {
        ...
        Person person1 = new Person("Witthawin", "Char");
        System.out.println(person1);
        Person person2 = new Person("Double", "Integer");
        ...
        System.out.println(person2);
        person2.setFirstname("Starlord");
        person2.setLastname("waa");
        System.out.println(person2 + "" + '\n');
    ...
    static void work03Account() {
         ...
         * and check their correctness.
         */
        Person person1 = new Person("Adana", "linner");
        Person person2 = new Person("Campus", "Sweet");
        ...
        System.out.println(account2.deposit(6500.00));
        System.out.println(account2.getBalance() + "" + '\n');

        System.out.println(account1.withdraw(1400.00));
        System.out.println(account1.getBalance());
        ...
        account1.transfer(2400.00, account2);
