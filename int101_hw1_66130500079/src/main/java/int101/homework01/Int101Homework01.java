...
public class Int101Homework01 {
    ...
    static void work03UseOfUtilityClass() {
         ...
         */
        System.out.println(MyUtil.calculateBMI(56.0, 1.66));

        System.out.println(MyUtil.average(1, 5, 6));
    }
    ...
    static void work04UseOfObjectClass() {
         ...
         */
        Person owner1 = new Person(01);
        Person owner2 = new Person(02);

        BankAccount account1 = new BankAccount(1, owner1);
        BankAccount account2 = new BankAccount(2, owner2);

        account1.deposit(659);
        account1.deposit(541);

        account1.withdraw(600);

        System.out.println("Account1 balance = " + account1.getBalance());

        account1.tranfer(200, account2);
